...
export class ClienteService{
    ...
    setIdCliente(cliente:Cliente):void{
       // console.log(this.url + '/setearCliente/'+cliente.idCliente);
        this.http.get(this.url + '/setearCliente/'+cliente.idCliente).map(response => response.json());
    }
    getClienteActual():Cliente{
      //  console.log("Cliente actual "+ this.clienteActual.idCliente);
        return this.clienteActual;
    }
    getIdClienteActual(id:number):Observable<number>{
      //  console.log(this.http.get(this.url + '/getCliente/').map(response => response.json()));
        return this.http.get(this.url + '/getCliente/').map(response => response.json());
    }
    /*
